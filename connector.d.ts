...
export type TerraWebExtensionFeatures = 'post' | 'sign' | 'sign-bytes' | 'cw20-token' | 'network';
export interface TerraWebExtensionConnector {
    ...
    refetchStates: () => void;
    post: (address: string, tx: CreateTxOptions) => Subscribable<WebExtensionTxResult<WebExtensionPostPayload>>;
    sign: (address: string, tx: CreateTxOptions) => Subscribable<WebExtensionTxResult<WebExtensionSignPayload>>;
